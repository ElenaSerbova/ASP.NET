    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseRouting(); //добавляет соответствие маршрута в конвейер ПО промежуточного слоя.
                              //Это ПО промежуточного слоя обращается к набору конечных точек,
                              //определенных в приложении, и выбирает наиболее подходящее
                              //на основе запроса.

            app.UseAuthorization();

            app.UseEndpoints(endpoints =>       // добавляет выполнение конечной точки в конвейер                                                
